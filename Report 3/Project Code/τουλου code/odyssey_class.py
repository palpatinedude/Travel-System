...
def main():
    ...
    #     response = Response(review_id=review.review_id, replier_id=2, reply_text="Thank you for your feedback!")
    #     response.save()
    ...
    #     response.reply_text = "Thank you very much for your feedback!"
    #     response.save()
