...
VALUES 
    (34, '123ABC', 'REG123', 'www.partner1.com', 'Description for Partner 1'),
    (35, '456DEF', 'REG456', 'www.partner2.com', 'Description for Partner 2'),
    (36, '789GHI', 'REG789', 'www.partner3.com', 'Description for Partner 3'),
    (37, 'ABC123', 'REGABC', 'www.partner4.com', 'Description for Partner 4');
    
    
INSERT INTO Beneficiary (user_id, beneficiary_type, date_of_birth, address, contact_number, location_status, membership_id) 
VALUES 
    (38, 'Simple User', '2000-01-01', 'Address 1', '1234567890', 'Active', NULL),
    (39, 'Service Provider', '1995-05-15', 'Address 2', '9876543210', 'Inactive', NULL),
    (40, 'Simple User', '1988-10-20', 'Address 3', '5555555555', 'Active', NULL),
    (41, 'Service Provider', '1975-12-31', 'Address 4', '7777777777', 'Inactive', NULL),
    (42, 'Simple User', '1992-03-08', 'Address 5', '9999999999', 'Active', NULL),
    (43, 'Service Provider', '1980-07-25', 'Address 6', '3333333333', 'Inactive', NULL),
    (44, 'Service Provider', '1980-08-25', 'Address 7', '1111111111', 'Inactive', NULL); 
    
    
INSERT INTO ServiceProvider (beneficiary_id, languages_spoken, specialties, certifications) 
VALUES 
    (9, 'English, Greek', 'Web Development', 'Certified Web Developer'),
    (12, 'English, Spanish', 'Legal Services', 'Bar Certified Lawyer'),
    (13, 'English, French', 'Healthcare', 'Medical Doctor'),
    (14, 'English, German', 'Consulting', 'Consultancy Certificate');    

INSERT INTO SimpleUser (beneficiary_id, bistory, preferences) 
VALUES 
    (8, 'This is the bio for simple user 1', 'Preferences for simple user 1'),
    (10, 'This is the bio for simple user 2', 'Preferences for simple user 2'),
    (11, 'This is the bio for simple user 3', 'Preferences for simple user 3');
    
INSERT INTO Service (provider_id, description, service_name, country_id, city_id)
VALUES
    (9, 'Bar Service Description', 'Bar Service', 1, 1),
    (10, 'Hotel Service Description', 'Hotel Service', 1, 1),
    (11, 'Food & Beverage Service Description', 'Food & Beverage Service', 1, 2),
    (12, 'Market Service Description', 'Market Service', 1, 1);

INSERT INTO Activity (service_id, activity_name, age_requirement, duration_hours, activity_description)
VALUES
    (5, 'Hiking', 10, 3, 'Guided hiking tour in the nearby mountains.');

INSERT INTO Accommodation (service_id, num_rooms, facilities)
VALUES
    (6, 50, 'WiFi, Parking, Pool');
    
INSERT INTO Car (service_id, car_model, year_of_manufacture, car_type, rental_rate)
VALUES
    (7, 'Toyota Camry', 2022, 'sedan', 50.00),
    (8, 'Honda CR-V', 2021, 'SUV', 60.00);    
...
VALUES
    (5, '2024-05-29', '09:00-12:00'),
    (5, '2024-05-29', '14:00-17:00'),
    (5, '2024-05-30', '09:00-12:00'),
    (5, '2024-05-30', '14:00-17:00'),
	(6, '2024-05-29', '14:00-12:00'),
    (6, '2024-05-30', '14:00-12:00'),
    (6, '2024-05-31', '14:00-12:00'),
    (6, '2024-06-01', '14:00-12:00'),
    (7, '2024-05-29', '09:00-17:00'),
    (7, '2024-05-30', '09:00-17:00'),
    (7, '2024-05-31', '09:00-17:00'),
    (7, '2024-06-01', '09:00-17:00'),
    (8, '2024-05-29', '09:00-17:00'),
    (8, '2024-05-30', '09:00-17:00'),
    (8, '2024-05-31', '09:00-17:00'),
    (8, '2024-06-01', '09:00-17:00');
